...
def get_dataloaders(config, distributed=True):
    ...
    print(config)
    if config.dataset == 'piano':
        train_set = CustomDataset(dataset_name='piano',split='train')
        valid_set = CustomDataset(dataset_name='piano',split='valid')
        ...
        train_set = CustomDataset(dataset_name='cifar10',split='train')
        valid_set = CustomDataset(dataset_name='cifar10',split='valid')
        train_loader = cycle_loader(DataLoader(dataset=train_set,
                                  shuffle=True,
                          num_workers=0,
                          batch_size=config.training.batch_size,
