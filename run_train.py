...
def _run(rank, world_size, cfg):
    ...
    while state['step'] < num_train_steps + 1:
        ...
        if cfg.data.train != "text8" and (cfg.data.train != "piano") and (cfg.data.train != "cifar10"):
        ...
        if step != state['step']:
            ...
            if step % cfg.training.eval_freq == 0:
                if cfg.data.valid != "text8" and (cfg.data.valid != "piano") and (cfg.data.valid != "cifar10"):
